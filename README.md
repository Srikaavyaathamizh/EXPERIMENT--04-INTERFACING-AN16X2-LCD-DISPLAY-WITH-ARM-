# EXPERIMENT04-INTERFACING AN16X2 LCD DISPLAY WITH ARM AND DISPLAY STRING
...
void lcd_display(){
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"SRIKAAVYAA T\n");

	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212223230214\n");
...
## Output screen shots of proteus  :
 ![Screenshot 2025-04-30 155338](https://github.com/user-attachments/assets/a3030565-929b-46e0-9a4a-43850f207e1b)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
![image](https://github.com/user-attachments/assets/30661ff1-baf7-4d6a-8f07-5c3ce6a67f90)
